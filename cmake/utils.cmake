...
#
function(cuda_archs_filter_by_min OUT_CUDA_ARCHS IN_CUDA_ARCHS MIN_CUDA_ARCH)
  set(_FILTERED_ARCHS)
  foreach(_arch ${IN_CUDA_ARCHS})
    set(_base "${_arch}")
    string(REPLACE "+PTX" "" _base "${_base}")
    string(REGEX REPLACE "[af]$" "" _base "${_base}")
    if("${_base}" VERSION_GREATER_EQUAL "${MIN_CUDA_ARCH}")
      list(APPEND _FILTERED_ARCHS "${_arch}")
    endif()
  endforeach()
  set(${OUT_CUDA_ARCHS} ${_FILTERED_ARCHS} PARENT_SCOPE)
endfunction()
...
function(cuda_archs_loose_intersection OUT_CUDA_ARCHS SRC_CUDA_ARCHS TGT_CUDA_ARCHS)
  ...
  if(_VLLM_CUDA_MIN_ARCH)
    cuda_archs_filter_by_min(_CUDA_ARCHS "${_CUDA_ARCHS}" "${_VLLM_CUDA_MIN_ARCH}")
  endif()
